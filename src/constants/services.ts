const services = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: '(Fluid, Cloth, Particle, Rigid Body Dynamics)',
      },
      {
        title: 'Procedural Animation',
        description: '(Parameter-Driven Motion, Generative Effects)',
      },
    ],
  },
  {
    ...
    description:
      'Photorealistic renderings and animations that showcase architectural projects before construction begins. Real-time engine support enables rapid iteration and client review, while maintaining cinematic visual fidelity.',
    items: [
      {
  ...
  },
  {
    ...
    description:
      'Cohesive brand identity systems that communicate professionalism and personality. From logo design to animated brand elements, every touchpoint is crafted to establish a memorable and consistent visual presence.',
    items: [
      {
      ...
      },
      {
        ...
        description: '(Print Design, Templates, Style Guides)',
      },
    ],
  },
]
